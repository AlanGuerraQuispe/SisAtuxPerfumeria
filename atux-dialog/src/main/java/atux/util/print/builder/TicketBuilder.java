...
public class TicketBuilder extends ComprobanteBuilder {
    ...
    public void printHeader(AtuxPrint vPrint) {
        ...
        vPrint.printBold(AtuxPRNUtility.alinearIzquierda(" ", 10) +AtuxPRNUtility.alinearIzquierda(AtuxVariables.vDescripcionCompania, 25), true);
...
//                            AtuxPRNUtility.alinearIzquierda(detallePedido.getProdLocal().getProducto().getLaboratorio().getDeLaboratorio(), 6), true);
    ...
    public void printPageFooter(AtuxPrint vPrint) {
        ...
        vPrint.printLine(AtuxPRNUtility.alinearIzquierda(" ", 0) + "Cada fragancia, una emocion.", true);
        vPrint.printLine(AtuxPRNUtility.alinearIzquierda(" ", 0) + "Descubre la tuya.\"", true);
        vPrint.printLine(" ", true);
