...
public class AtuxDBUtility {
    ...
    public static String getFechaHoraBD(int pTipo) throws SQLException {
        ...
        // Ejecutar el query haciendo uso de la conexiï¿½n por default
     ...
     * @return <b>String</b> Colección de datos - resultado del Query.
     */
     ...
     *
     * @param <b>pResultSet</b> Colección de datos a cerrar.  Por medio de este
     *                          objeto obtenemos el Statement usado el cual tambiÃ©n
     *                          es cerrado.
     */
    ...
    public static void executeSQLUpdate(Connection connection,String pSQLUpdate) throws SQLException {
        ...
        // Controla el COMMIT automÃ¡tico
     ...
     * Mï¿½todo usado en los siguientes casos :
     * 1. Ejecutar Stored Procedures con o sin parámetros y estos retornan un objeto
     * del tipo OracleTypes.CURSOR
     * 2. Ejecutar Stored Procedures con o sin parámetros que no retornan nada, sílo
     ...
     * @param <b>pParameters</b>      Arreglo de Objetos (parámetros) usados en el Stored
     *                                Procedure.
     * @param <b>pWithCheck</b>       Variable boolean que indica si en el JTable existirï¿½ una
    ...
    public static void executeSQLStoredProcedure(AtuxTableModel pTableModel,
        ...
        if (pTableModel != null) {
            ...
            // columnas ... cada registro viene como un String en el que los campos estï¿½n
            // concatenados por el character "ï¿½".
     ...
     * @param <b>pParameters</b>      Arreglo de Objetos (parámetros) usados en el Stored
     *                                Procedure.
     * @return <b>String</b> Objeto String devuelto por la ejecución del Stored Procedure.
     */
     ...
     * @param <b>pParameters</b>      Arreglo de Objetos (parámetros) usados en el Stored
     *                                Procedure.
     * @return <b>int</b> integer devuelto por la ejecución del Stored Procedure.
     */
     ...
     * @param <b>pParameters</b>      Arreglo de Objetos (parámetros) usados en el Stored
     *                                Procedure.
     * @return <b>double</b> double devuelto por la ejecución del Stored Procedure.
     */
    ...
    public static String getValueAt(String tableName, String fieldCode,
        ...
        if (results.next()) throw new SQLException("Existe más de 1 registro", "EckerdError", 9000);
        results.close();
        stmt.close();
        if (valor == null) valor = "";
        return valor;
