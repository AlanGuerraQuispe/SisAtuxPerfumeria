...
public class Helper {
    ...
    private final static String PASSNAME = "aguerra"; //no cambiar
    ...
    public static void ajustarAnchoColumnasNew(JTable table,Integer[] AnchoPredefinido) {
        TableColumnModel columnModel = table.getColumnModel();

        FormatoTabla formatColumn = new FormatoTabla();

        for (int col=0; col<table.getColumnCount(); col++) {

            TableColumn column = columnModel.getColumn (col);
            column.setPreferredWidth (AnchoPredefinido[col]);
            table.setDefaultRenderer(Object.class, formatColumn);
        } // para columnas

    }

    public static void ajustarSoloAnchoColumnas(JTable table,Integer[] AnchoPredefinido) {
        TableColumnModel columnModel = table.getColumnModel();

        FormatoGrilla formatColumn = new FormatoGrilla();
    ...
    public static void ajustarSoloAnchoColumnasTablaConsulta(JTable table,Integer[] AnchoPredefinido) {
        TableColumnModel columnModel = table.getColumnModel();

        FormatoTablaPedidos formatColumn = new FormatoTablaPedidos();
    ...
    public static void ajustarSoloAnchoColumnasPedCredito(JTable table,Integer[] AnchoPredefinido) {
        TableColumnModel columnModel = table.getColumnModel();

        FormatoGrillaPedidoCredito formatColumn = new FormatoGrillaPedidoCredito();
