...
public class ModeloTablaProducto extends ModeloTabla{
    ...
    public static final String[] columnasVenta  = {"Código","Producto","Unidad","Prec.Venta",
    ...
    public static final String[] columnasInsumosPro  = {"Código","Insumo para Producto","Unidad","Prec.Venta",
                                                        "Descuento","Prec.Público", "Stock","Bono"};

    public static final String[] columnasPromociones= {"Promoción","Laboratorio"};

    public static final Integer[] anchoColumnas  = {50,257,85,65,65,71,37,37};
            ...
            case PRO_LISTA: 
                switch(columnIndex)
                 {                     
                     ...
                     case 4:return ((ProductoLocal)registros.get(rowIndex)).getPcDescuento_1();
                     case 5:return ((ProductoLocal)registros.get(rowIndex)).getVaPrecioPublico();
                     case 6:return ((ProductoLocal)registros.get(rowIndex)).getCaStockDisponible();
                     case 7:return ((ProductoLocal)registros.get(rowIndex)).getProducto().getVaBono();
//                     case 8:return 0;
                 }
                break;
            case PRO_INSUMOS:
                switch(columnIndex)
                {
                    ...
                    case 2:return ((ProductoLocal)registros.get(rowIndex)).getDeUnidadFraccion();
                    case 3:return ((ProductoLocal)registros.get(rowIndex)).getVaPrecioPublico();
                    case 4:return 0;
                    case 5:return ((ProductoLocal)registros.get(rowIndex)).getVaPrecioPublico();
                    case 6:return 0;
                    case 7:return 0;
