...
public final class IPedidoVenta extends javax.swing.JInternalFrame {          
    ...
    public IPedidoVenta(String enviroment) {
    ...
    private void initComponents() {
        ...
        panelImage1Layout.setHorizontalGroup(
            ...
            .addComponent(pnlActionButtons, javax.swing.GroupLayout.DEFAULT_SIZE, 926, Short.MAX_VALUE)
    ...
    private void bntGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntGuardarActionPerformed
        try {
            ...
            Logger.getLogger(IPedidoVenta.class.getName()).log(Level.SEVERE, null, ex);
    ...
    {                        
        ...
        if(AtuxVariables.vInTicketBoleta.equalsIgnoreCase("S") && rbTicketBoleta.isSelected()) {
           ...
           if(AtuxVariables.vInTicketBoleta.equalsIgnoreCase("N") && rbTicketBoleta.isSelected()) {
            pedido.setTiComprobante(AtuxVariables.TIPO_BOLETA);                              
         }
         else 
           if(AtuxVariables.vInTicketFactura.equalsIgnoreCase("S") && rbTicketFactura.isSelected()) {
            pedido.setTiComprobante(AtuxVariables.TIPO_TICKET_FACTURA);                              
         }
           else  
            if(AtuxVariables.vInTicketFactura.equalsIgnoreCase("N") && rbTicketFactura.isSelected()) {
    ...
    private void imprimeTestigoNew() {
      try {
            ...
            //testigoPrint.setTblProductos(tblProductos);
