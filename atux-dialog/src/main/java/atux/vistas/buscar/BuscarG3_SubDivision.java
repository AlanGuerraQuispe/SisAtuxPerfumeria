...
public class BuscarG3_SubDivision extends javax.swing.JPanel {
    ...
    public BuscarG3_SubDivision(int opcion) {
        initComponents();
    ...
    private void LlenarGrid(){
        ...
        if(!txtDato.getText().isEmpty()){            
            columnas = new String[]{"DE_GRUPO_ANATOMICO","ES_GRUPO_ANATOMICO","CO_NIVEL_SUPERIOR"};
            valores = new Object[]{txtDato.getText(),Estado,this.CoNivelSuperior}; 
        }else{
            columnas = new String[]{"ES_GRUPO_ANATOMICO","CO_NIVEL_SUPERIOR"};
            valores = new Object[]{Estado,this.CoNivelSuperior}; 
        }         
        
        this.mtp = new ModeloTablaG3_SubDivision(columnas,valores);
        this.tblListado.setModel(mtp);
    }
            
    public BuscarG3_SubDivision() {
        initComponents();
        lbAviso.setVisible(false);
        mtp = new ModeloTablaG3_SubDivision();
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                    ...
                    .addComponent(lbAviso, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(194, 194, 194)))
        );
    ...
    public JAbstractModelBD getG3_SubDivision()
    {
        if(cp!=null){
            return (JAbstractModelBD)cp.getG3_SubDivision();
        }
        return null;
    }
