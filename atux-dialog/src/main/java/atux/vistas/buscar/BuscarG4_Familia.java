...
public class BuscarG4_Familia extends javax.swing.JPanel {
    ...
    public BuscarG4_Familia(int opcion) {
        initComponents();
    ...
    private void LlenarGrid(){
        ...
        if(!txtDato.getText().isEmpty()){            
            columnas = new String[]{"DE_GRUPO_TERAPEUTICO","ES_GRUPO_TERAPEUTICO","CO_NIVEL_SUPERIOR"};
            valores = new Object[]{txtDato.getText(),Estado,this.CoNivelSuperior}; 
        }else{
            columnas = new String[]{"ES_GRUPO_TERAPEUTICO","CO_NIVEL_SUPERIOR"};
            valores = new Object[]{Estado,this.CoNivelSuperior}; 
        }         
        
        this.mtp = new ModeloTablaG4_Familia(columnas,valores);
        this.tblListado.setModel(mtp);
    }
            
    public BuscarG4_Familia() {
        initComponents();
        lbAviso.setVisible(false);
        mtp = new ModeloTablaG4_Familia();
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                    ...
                    .addComponent(lbAviso, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(194, 194, 194)))
        );
    ...
    public JAbstractModelBD getG4_Familia()
    {
        if(cp!=null){
            return (JAbstractModelBD)cp.getG4_Familia();
        }
        return null;
    }
