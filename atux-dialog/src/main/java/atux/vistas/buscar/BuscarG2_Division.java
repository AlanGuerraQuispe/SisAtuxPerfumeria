...
public class BuscarG2_Division extends javax.swing.JPanel {
    ...
    public BuscarG2_Division(int opcion) {
        initComponents();
    ...
    private void LlenarGrid(){
        ...
        if(!txtDato.getText().isEmpty()){            
            columnas = new String[]{"DE_GRUPO_PROD_ERP","ES_GRUPO_PROD_ERP","CO_NIVEL_SUPERIOR"};
            valores = new Object[]{txtDato.getText(),Estado,this.CoNivelSuperior}; 
        }else{
            columnas = new String[]{"ES_GRUPO_PROD_ERP","CO_NIVEL_SUPERIOR"};
            valores = new Object[]{Estado,this.CoNivelSuperior}; 
        }         
        
        this.mtp = new ModeloTablaG2_Division(columnas,valores);
        this.tblListado.setModel(mtp);
    }
            
    public BuscarG2_Division() {
        initComponents();
        lbAviso.setVisible(false);
        mtp = new ModeloTablaG2_Division();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtDato, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void txtDatoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDatoKeyReleased
        AtuxGridUtils.buscarDescripcion(evt, tblListado, txtDato, 1);
    ...
    private void txtDatoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDatoKeyPressed
        AtuxGridUtils.aceptarTeclaPresionada(evt, tblListado, txtDato, 1);
    }//GEN-LAST:event_txtDatoKeyPressed

    public JAbstractModelBD getG2_Division()
    {
        if(cp!=null){
            return (JAbstractModelBD)cp.getG2_Division();
        }
        return null;
    }
