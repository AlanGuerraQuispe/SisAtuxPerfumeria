...
public class BuscarG1_LineaComercial extends javax.swing.JPanel {
    ...
    public BuscarG1_LineaComercial(int opcion) {
        initComponents();
        ...
        switch(opcion)
        {
            case 0:
            case 1:
                mtp = new ModeloTablaG1_LineaComercial(opcion,0,0);
                break;
            default:                
                mtp = new ModeloTablaG1_LineaComercial();
        }
    ...
    public BuscarG1_LineaComercial() {
        initComponents();
        lbAviso.setVisible(false);
        mtp = new ModeloTablaG1_LineaComercial();
        tblListado.setModel(mtp);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                    ...
                    .addComponent(lbAviso, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(194, 194, 194)))
        );
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        if(!txtDato.getText().isEmpty()){
            ...
            columnas = new String[]{"DE_LINEA_PROD_ERP"};
            this.mtp = new ModeloTablaG1_LineaComercial(columnas,valores);
    ...
    public JAbstractModelBD getG1_LineaComercial()
    {
        if(cp!=null){
            return (JAbstractModelBD)cp.getG1_LineaComercial();
        }
        return null;
    }
