...
public class Producto extends JAbstractModelBD implements Serializable,IModel{
    ...
    public static final String[]
                CAMPOS_Maestros = {"CO_COMPANIA, CO_PRODUCTO, NU_REVISION_PRODUCTO, DE_PRODUCTO, CO_MONEDA, CO_IMPUESTO_1, "
                ...
                + "CO_PROCEDENCIA, FE_VIGENCIA, IN_CONTROL_LOTE, IN_PIDE_MEDICO, TI_MATERIAL_SAP,IN_GENERO,CO_PRODUCTO_SAP"};
        ...
        public static final String[]
                ...
                + "FE_CREA_PRODUCTO, ID_MOD_PRODUCTO, FE_MOD_PRODUCTO, PC_DESCUENTO_BASE, VA_COSTO_PRODUCTO, "
                + "VA_PRECIO_PUBLICO, IN_CONTROLADO, CO_NIVEL_01, CO_NIVEL_02, CO_NIVEL_03, CO_NIVEL_04, CO_NIVEL_05, "
                + "CO_PROCEDENCIA, FE_VIGENCIA, IN_CONTROL_LOTE, IN_PIDE_MEDICO,TI_MATERIAL_SAP"};
