...
public class ProductoInsumo extends JAbstractModelBD implements Serializable,IModel{
    ...
    public static final String[] COLUMNA_ORDER ={"CO_PRODUCTO_INSUMO"};
    ...
    FULL_NOM_CAMPOS ={" CO_COMPANIA,CO_PRODUCTO,NU_REVISION_PRODUCTO, CO_PRODUCTO_INSUMO,"
            + "IN_IMPRESION, DE_OBSERVACION, VA_COSTO, VA_PRECIO_PUBLICO, DE_UNIDAD_INSUMO,ES_PRODUCTO_INSUMO,"
            + "ID_CREA_PRODUCTO_INSUMO, FE_CREA_PRODUCTO_INSUMO"};

    public static final String[]
      CAMPOS_NO_ID ={"IN_IMPRESION, DE_OBSERVACION, VA_COSTO, VA_PRECIO_PUBLICO, DE_UNIDAD_INSUMO,ES_PRODUCTO_INSUMO,"
            + "ID_MOD_PRODUCTO_INSUMO, FE_MOD_PRODUCTO_INSUMO"};
