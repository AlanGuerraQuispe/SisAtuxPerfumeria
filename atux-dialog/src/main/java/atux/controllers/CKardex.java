...
public class CKardex extends JAbstractController{
    ...
    public ArrayList getRegistros(String[] campos, String[] columnaId, Object[] id) {
        ...
        try {
            ...
            rs = this.getRegistros(Kardex.nt,campos,columnaId,id,null);
            if(this.numRegistros<finalPag)
           {
            ...
            {
                   us = new Kardex();
                   us.setPrimaryKey(new String[]{rs.getString(1),rs.getString(2),rs.getString(3)});   
