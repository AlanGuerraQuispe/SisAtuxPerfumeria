...
rem
rem Este instalador desplegara el Deominio Replicador Active Directory.
rem Copyright (c) 2009 SIDER PERU - AGILE WORKS.
rem
...
set _WRAPPER_CONF="%_REALPATH%..\conf\wrapperqa.conf"
