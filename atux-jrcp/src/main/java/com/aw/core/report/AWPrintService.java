...
//2.0.1import com.aw.core.db.DbUtil;
...
public class AWPrintService {
  ...
  */
  ...
  public String obtenerFechaBaseDatos() {
      Date fechaSistema = null;//DbUtil.instance().getCurrentDate(); 2.0.1
    ...
    public String obtenerHoraBaseDatos(){
        Date fechaSistema = null;//DbUtil.instance().getCurrentDate(); jcv2.0.1
