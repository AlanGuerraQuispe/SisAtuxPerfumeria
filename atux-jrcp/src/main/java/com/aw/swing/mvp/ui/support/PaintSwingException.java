 ...
 * Date: Oct 1, 2007
 */
public class PaintSwingException implements PaintException {


    public List getBindingComponents(Throwable exception) {
        AWSwingException awSwingException = (AWSwingException) exception;
        return Arrays.asList(new Object[]{(((JComponent) awSwingException.getJComponent()).getClientProperty(BindingComponent.ATTR_BND))});
    }
