...
public class Bundles {
    ...
    */
    ...
    /** Get a resource bundle in the same datosAdicionales as the provided class,
    * with the default locale/branding and the class' own classloader.
    * This is the usual style of invocation.
    *
    * @param clazz the class to take the datosAdicionales name from
    * @return the resource bundle
    * @exception MissingResourceException if the bundle does not exist
    */
    ...
    /** Finds datosAdicionales name for given class */
    private static String findName(Class clazz) {
        ...
        if (last >= 0) {
            ...
            // base datosAdicionales, search for bundle
