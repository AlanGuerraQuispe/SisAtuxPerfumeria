 ...
 */
public class JButtonLinkB extends JButton {

    public JButtonLinkB() {
        super();
    }

    public JButtonLinkB(String text) {
        super(text);
    }

    public JButtonLinkB(String text, Icon icon) {
        super(text, icon);
    }

    public JButtonLinkB(Action a) {
        super(a);
    }

    public JButtonLinkB(Icon icon) {
        super(icon);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        frame.getContentPane().add("Center", new JButtonLinkB("www.java2s.com"));
    ...
    static class BasicLinkButtonUI extends BasicButtonUI {
    ...
    static class WindowsLinkButtonUI extends BasicLinkButtonUI {
