 ...
 * Date: 20/06/2009
 */
public class CustomButtonPainter extends AbstractRegionPainter {
    ...
    private Color color1 = decodeColor("customDefaultButton", -0.027777791f, -0.06885965f, -0.36862746f, -190);
        private Color color2 = decodeColor("customButton", 5.1498413E-4f, -0.34585923f, -0.007843137f, 0);
        private Color color3 = decodeColor("customButton", 5.1498413E-4f, -0.095173776f, -0.25882354f, 0);
        private Color color4 = decodeColor("customButton", 0.004681647f, -0.6197143f, 0.43137252f, 0);
        private Color color5 = decodeColor("customButton", 0.004681647f, -0.5766426f, 0.38039213f, 0);
        private Color color6 = decodeColor("customButton", 5.1498413E-4f, -0.43866998f, 0.24705881f, 0);
        private Color color7 = decodeColor("customButton", 5.1498413E-4f, -0.46404046f, 0.36470586f, 0);
        private Color color8 = decodeColor("customButton", 5.1498413E-4f, -0.47761154f, 0.44313723f, 0);
        private Color color9 = decodeColor("nimbusFocus", 0.0f, 0.0f, 0.0f, 0);
        private Color color10 = decodeColor("customButton", 0.0013483167f, -0.1769987f, -0.12156865f, 0);
        private Color color11 = decodeColor("customButton", 0.059279382f, 0.3642857f, -0.43529415f, 0);
        private Color color12 = decodeColor("customButton", 0.004681647f, -0.6198413f, 0.43921566f, 0);
        private Color color13 = decodeColor("customButton", -0.0017285943f, -0.5822163f, 0.40392154f, 0);
        private Color color14 = decodeColor("customButton", 5.1498413E-4f, -0.4555341f, 0.3215686f, 0);
        private Color color15 = decodeColor("customButton", 5.1498413E-4f, -0.47698414f, 0.43921566f, 0);
        private Color color16 = decodeColor("customButton", -0.06415892f, -0.5455182f, 0.45098037f, 0);
        private Color color17 = decodeColor("customDefaultButton", 0.0f, -0.110526316f, 0.25490195f, -95);
        private Color color18 = decodeColor("customButton", -0.57865167f, -0.6357143f, -0.54901963f, 0);
        private Color color19 = decodeColor("customButton", -3.528595E-5f, 0.018606722f, -0.23137257f, 0);
        private Color color20 = decodeColor("customButton", -4.2033195E-4f, -0.38050595f, 0.20392156f, 0);
        private Color color21 = decodeColor("customButton", 0.001903832f, -0.29863563f, 0.1490196f, 0);
        private Color color22 = decodeColor("customButton", 0.0f, 0.0f, 0.0f, 0);
        private Color color23 = decodeColor("customButton", 0.0018727183f, -0.14126986f, 0.15686274f, 0);
        private Color color24 = decodeColor("customButton", 8.9377165E-4f, -0.20852983f, 0.2588235f, 0);
        private Color color25 = decodeColor("customDefaultButton", -0.027777791f, -0.06885965f, -0.36862746f, -232);
        private Color color26 = decodeColor("customDefaultButton", 0.0f, -0.06766917f, 0.07843137f, 0);
        private Color color27 = decodeColor("customDefaultButton", 0.0f, -0.06484103f, 0.027450979f, 0);
        private Color color28 = decodeColor("customDefaultButton", 0.0f, -0.08477524f, 0.16862744f, 0);
        private Color color29 = decodeColor("customDefaultButton", -0.015872955f, -0.080091536f, 0.15686274f, 0);
        private Color color30 = decodeColor("customDefaultButton", 0.0f, -0.07016757f, 0.12941176f, 0);
        private Color color31 = decodeColor("customDefaultButton", 0.0f, -0.07052632f, 0.1372549f, 0);
        private Color color32 = decodeColor("customDefaultButton", 0.0f, -0.070878744f, 0.14509803f, 0);
        private Color color33 = decodeColor("customDefaultButton", -0.055555522f, -0.05356429f, -0.12549019f, 0);
        private Color color34 = decodeColor("customDefaultButton", 0.0f, -0.0147816315f, -0.3764706f, 0);
        private Color color35 = decodeColor("customDefaultButton", 0.055555582f, -0.10655806f, 0.24313724f, 0);
        private Color color36 = decodeColor("customDefaultButton", 0.0f, -0.09823123f, 0.2117647f, 0);
        private Color color37 = decodeColor("customDefaultButton", 0.0f, -0.0749532f, 0.24705881f, 0);
        private Color color38 = decodeColor("customDefaultButton", 0.0f, -0.110526316f, 0.25490195f, 0);
        private Color color39 = decodeColor("customDefaultButton", 0.0f, -0.020974077f, -0.21960783f, 0);
        private Color color40 = decodeColor("customDefaultButton", 0.0f, 0.11169591f, -0.53333336f, 0);
        private Color color41 = decodeColor("customDefaultButton", 0.055555582f, -0.10658931f, 0.25098038f, 0);
        private Color color42 = decodeColor("customDefaultButton", 0.0f, -0.098526314f, 0.2352941f, 0);
        private Color color43 = decodeColor("customDefaultButton", 0.0f, -0.07333623f, 0.20392156f, 0);
        private Color color44 = new Color(245, 250, 255, 160);
        private Color color45 = decodeColor("customDefaultButton", 0.055555582f, 0.8894737f, -0.7176471f, 0);
        private Color color46 = decodeColor("customDefaultButton", 0.0f, 5.847961E-4f, -0.32156864f, 0);
        private Color color47 = decodeColor("customDefaultButton", -0.00505054f, -0.05960039f, 0.10196078f, 0);
        private Color color48 = decodeColor("customDefaultButton", -0.008547008f, -0.04772438f, 0.06666666f, 0);
        private Color color49 = decodeColor("customDefaultButton", -0.0027777553f, -0.0018306673f, -0.02352941f, 0);
        private Color color50 = decodeColor("customDefaultButton", -0.0027777553f, -0.0212406f, 0.13333333f, 0);
        private Color color51 = decodeColor("customDefaultButton", 0.0055555105f, -0.030845039f, 0.23921567f, 0);
    ...
    public CustomButtonPainter(int state) {
        super();
        this.state = state;
        Insets insets = new Insets(7, 7, 7, 7);
        Dimension canvasSize = new Dimension(104, 33);
