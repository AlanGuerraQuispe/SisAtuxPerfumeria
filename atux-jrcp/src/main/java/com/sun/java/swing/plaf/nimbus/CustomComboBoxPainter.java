 ...
 * Date: 01/09/2009
 */
public class CustomComboBoxPainter extends AbstractRegionPainter {
    ...
    public static final int BACKGROUND_REQUIRED_ENABLED = 15;
    public static final int BACKGROUND_REQUIRED_PRESSED = 16;
    public static final int BACKGROUND_REQUIRED_MOUSEOVER = 17;
    public static final int BACKGROUND_REQUIRED_PRESSED_FOCUSED = 18;
    public static final int BACKGROUND_REQUIRED_FOCUSED = 19;
    public static final int BACKGROUND_REQUIRED_FOCUSED_MOUSEOVER = 20;
...
//    private Color color14 = decodeColor("nimbusBlueGrey", 0.0f, 0.0f, -0.22f, -176);
    private Color color14 = new Color(255, 255, 255);
    ...
    public CustomComboBoxPainter(int state) {
        super();
        this.state = state;
        Insets insets = new Insets(8, 9, 8, 19);
        Dimension canvasSize = new Dimension(83, 24);
...
//                paintBackgroundEnabled(g);
            ...
            case BACKGROUND_PRESSED_EDITABLE:
                ...
                break;
            case BACKGROUND_REQUIRED_ENABLED:
                paintBackgroundWhenIsRequired(g);
                break;
            case BACKGROUND_REQUIRED_PRESSED_FOCUSED:
                paintBackgroundWhenIsRequiredPressedFocused(g);
                break;
            case BACKGROUND_REQUIRED_FOCUSED:
                paintBackgroundWhenIsRequiredFocused(g);
                break;
            case BACKGROUND_REQUIRED_MOUSEOVER:
                paintBackgroundWhenIsRequiredMouseOver(g);
                break;
            case BACKGROUND_REQUIRED_FOCUSED_MOUSEOVER:
                paintBackgroundRequiredFocusedAndMouseOver(g);
                break;
        }
    }
    ...
    private void paintBackgroundWhenIsRequired(Graphics2D g) {
        path = decodePath1();
        g.setPaint(color14);
        g.fill(path);
        path = decodePath2();
        ...
        g.setColor(ColorInfoProvider.COLOR_ERROR);
        g.fill(path);
    ...
    private void paintBackgroundWhenIsRequiredPressedFocused(Graphics2D g) {
       roundRect = decodeRoundRect1();
        g.setPaint(color26);
        g.fill(roundRect);
        path = decodePath2();
    ...
    private void paintBackgroundWhenIsRequiredFocused(Graphics2D g) {
        roundRect = decodeRoundRect1();
        g.setPaint(color26);
        g.fill(roundRect);
        path = decodePath2();
    ...
    private void paintBackgroundWhenIsRequiredMouseOver(Graphics2D g) {
        path = decodePath1();
        g.setPaint(color14);
        g.fill(path);
        path = decodePath2();
    ...
    private void paintBackgroundRequiredFocusedAndMouseOver(Graphics2D g) {
        roundRect = decodeRoundRect1();
        g.setPaint(color26);
        g.fill(roundRect);
        path = decodePath2();
