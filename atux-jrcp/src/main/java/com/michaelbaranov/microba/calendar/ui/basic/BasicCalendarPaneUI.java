...
public class BasicCalendarPaneUI extends CalendarPaneUI implements
    ...
    protected static final String F10_KEY = "##CalendarPaneUI.f10##";
	...
	protected void installKeyboardActions() {
        ...
        input.put(KeyStroke.getKeyStroke(KeyEvent.VK_F10, 0), ENTER_KEY);
		...
		input.put(KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_DOWN, 0),
						"pgdownkey");
