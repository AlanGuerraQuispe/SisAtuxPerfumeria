...
//        try {
//            strings.load(DefaultCalendarResources.class.getResourceAsStream(RESOURCE_FILE));
        strings.put("es.key.none", "Cancelar");
        strings.put("es.key.today", "Hoy");
        strings.put("en.key.none", "none");
        strings.put("en.key.today", "today");
