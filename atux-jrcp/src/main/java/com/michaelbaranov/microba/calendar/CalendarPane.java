...
public class CalendarPane extends MicrobaComponent implements CalendarColors {
	 ...
	 * 
	 * @param visible
	 *            <code>true</code> to show the today-button <code>false</code>
	 *            to hide
	 */
	 ...
	 * 
	 * <ul>
	 * <li><code> {@link JFormattedTextField#COMMIT}</code> <li><code>
	 * {@link JFormattedTextField#COMMIT_OR_REVERT}</code> <li><code>
	 * {@link JFormattedTextField#REVERT}</code> <li><code>
	 * {@link JFormattedTextField#PERSIST}</code>
	 * </ul>
	 ...
	 * 
	 * @param stripTime
	 *            <code>true</code> to strip time, <code>false</code> to keep
	 *            time
	 */
	 ...
	 * 
	 * @param commit
	 *            <code>true</code> to indicate commit, <code>false</code> to
	 *            indicate revert
	 * @see CommitEvent
	 * @see CommitListener
	 */
	...
	public void observeMonth(int year, int month) {
		((CalendarPaneUI) getUI()).observeMonth(year, month);
	}
