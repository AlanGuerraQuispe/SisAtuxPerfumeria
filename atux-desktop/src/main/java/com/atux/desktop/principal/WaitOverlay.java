...
public class WaitOverlay extends JPanel {
    ...
    WaitOverlay(JComponent clip) {
        ...
        this.clip = clip;
        this.text = "Verificando Credenciales...";
    ...
    public void setVisible(boolean visible) {
        if (visible) {
            ...
            glowTimer = new Animator(800,Double.POSITIVE_INFINITY, Animator.RepeatBehavior.REVERSE,
                                             new TimingTarget() {
                public void begin() {
                }
                public void end() {
    ...
    private void startFadeOut() {
        Animator timer = PropertySetter.createAnimator(4000,this,"fade",1.0f,0.0f);
    ...
    private void paintBackground(Graphics2D g2) {
        ...
        g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,
                                                   opacity));
//        g2.setColor(color);
        //jcv:color de fondo convertirlo a constante
        g2.setColor(new Color(0.12f, 0.33f, 0.54f, 1.0f));
