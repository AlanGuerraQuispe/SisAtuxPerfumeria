...
public class SeleccionarVentaDiaPst extends SeleccionarRangoPst {
    ...
    protected void registerActions() {
        ...
        }.setTargetPstClass(VentaPorDiaPst.class);
    ...
    public static void main(String[] args) {
        ...
        Presenter presenter = PstMgr.instance().getPst(SeleccionarVentaDiaPst.class);
        presenter.init();
    }
