 ...
 */
public class FrmFNTomaInventarioProducto {
    ...
    private void createUIComponents() {
        pnlForm = new ZonePanel("Lista de Laboratorios por Toma Inventario", true);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        createUIComponents();
        pnlMain = new JPanel();
        pnlMain.setLayout(new FormLayout("fill:d:grow", "fill:38dlu:noGrow,top:4dlu:noGrow,fill:300dlu:noGrow,top:4dlu:noGrow,fill:16dlu:noGrow"));
        ...
        footerPanel.setLayout(new FormLayout("fill:d:noGrow,left:4dlu:noGrow,fill:max(d;4px):noGrow,left:4dlu:noGrow,right:d:grow", "fill:d:grow"));
